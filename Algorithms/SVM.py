...
model = SVC(kernel="rbf", C=1, class_weight="balanced", random_state=42)
...
model_pca = SVC(kernel="rbf", C=1, class_weight="balanced", random_state=42)
...
model_lda = SVC(kernel="rbf", C=1, class_weight="balanced", random_state=42)
